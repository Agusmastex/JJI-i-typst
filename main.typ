...
Con los sistemas de seguridad pasivos, se opta por depender de fenómenos físicos como la gravedad o las diferencias de presión, en lugar de sistemas que dependen de fuentes de energía externa como bombas, ventiladores, o controladores lógicos programables. // @IAEA-TECDOC-626
...
Dado esto, la implementación de sistemas de refrigeración pasivos en los reactores nucleares es crucial, de modo a lograr disipar el calor residual de la reacción nuclear por un lapso de tiempo
